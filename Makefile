...
migrateup1:
	migrate -path db/migrations -database "postgresql://root:secret@localhost:5432/agentic_bank_server?sslmode=disable" -verbose up 1
...
migratedown1:
	migrate -path db/migrations -database "postgresql://root:secret@localhost:5432/agentic_bank_server?sslmode=disable" -verbose down 1
